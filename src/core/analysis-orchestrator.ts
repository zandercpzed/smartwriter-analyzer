...
export class AnalysisOrchestrator {
  ...
  constructor(settings: SmartWriterSettings, llmService: LLMService, cacheManager: CacheManager) {
  ...
  async analyze(request: AnalysisRequest, onProgress?: ProgressCallback): Promise<FullReport> {
  ...
  private async generateExecutiveSummary(
    ...
    return {
      ...
      scores,
      recommendation,
      notes: `Analysis based on ${structure.totalWords.toLocaleString()} words across ${
